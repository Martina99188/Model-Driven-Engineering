...
// import NewGlot.FormConcern.FormConcernTables;
...
public class FormConcernTables extends AbstractTables
{
	...
	public static final /*@NonInvalid*/ ClassId CLSSid_Attribute = FormConcernTables.PACKid_https_c_s_s_it_disim_mde_s_glot_s_dataConcern.getClassId("Attribute", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_DynamicForm = FormConcernTables.PACKid_https_c_s_s_it_disim_mde_s_glot_s_contentConcern.getClassId("DynamicForm", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Element = FormConcernTables.PACKid_https_c_s_s_it_disim_mde_s_glot_s_formConcern.getClassId("Element", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Entity = FormConcernTables.PACKid_https_c_s_s_it_disim_mde_s_glot_s_dataConcern.getClassId("Entity", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Form = FormConcernTables.PACKid_https_c_s_s_it_disim_mde_s_glot_s_formConcern.getClassId("Form", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_System = FormConcernTables.PACKid_http_c_s_s_it_disim_mde_s_newGlot.getClassId("System", 0);
	public static final /*@NonInvalid*/ EnumerationId ENUMid__MethodType = FormConcernTables.PACKid_https_c_s_s_it_disim_mde_s_glot_s_formConcern.getEnumerationId("_MethodType");
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_DynamicForm = TypeId.BAG.getSpecializedId(FormConcernTables.CLSSid_DynamicForm, false, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Element = TypeId.ORDERED_SET.getSpecializedId(FormConcernTables.CLSSid_Element, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	...
	public static class Fragments {
		...
		private static final ExecutorFragment _Element__NamedElement = new ExecutorFragment(Types._Element, NewGlotTables.Types._NamedElement);
		...
		private static final ExecutorFragment _Form__NamedElement = new ExecutorFragment(Types._Form, NewGlotTables.Types._NamedElement);
	...
	public static class Properties {
		...
		public static final ExecutorProperty _Element__hint = new EcoreExecutorProperty(FormConcernPackage.Literals.ELEMENT__HINT, Types._Element, 1);
		public static final ExecutorProperty _Element__label = new EcoreExecutorProperty(FormConcernPackage.Literals.ELEMENT__LABEL, Types._Element, 2);
		...
		public static final ExecutorProperty _Form__entity = new EcoreExecutorProperty(FormConcernPackage.Literals.FORM__ENTITY, Types._Form, 1);
		public static final ExecutorProperty _Form__method = new EcoreExecutorProperty(FormConcernPackage.Literals.FORM__METHOD, Types._Form, 2);
		public static final ExecutorProperty _Form__DynamicForm__form = new ExecutorPropertyWithImplementation("DynamicForm", Types._Form, 3, new EcoreLibraryOppositeProperty(ContentConcernPackage.Literals.DYNAMIC_FORM__FORM));
		public static final ExecutorProperty _Form__System__forms = new ExecutorPropertyWithImplementation("System", Types._Form, 4, new EcoreLibraryOppositeProperty(NewGlotPackage.Literals.SYSTEM__FORMS));
		static {
			Init.initEnd();
		}
	...
	public static class FragmentProperties {
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Element = {
			...
			FormConcernTables.Properties._Element__hint,
