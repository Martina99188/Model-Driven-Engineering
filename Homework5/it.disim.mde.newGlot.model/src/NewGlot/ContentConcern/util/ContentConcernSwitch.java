...
public class ContentConcernSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ContentConcernPackage.DYNAMIC_FORM: {
				DynamicForm dynamicForm = (DynamicForm)theEObject;
				T result = caseDynamicForm(dynamicForm);
				if (result == null) result = caseNamedElement(dynamicForm);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ContentConcernPackage.ADVERTISMENT: {
				Advertisment advertisment = (Advertisment)theEObject;
				T result = caseAdvertisment(advertisment);
				if (result == null) result = caseDynamicContent(advertisment);
				if (result == null) result = caseNamedElement(advertisment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Dynamic Form</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Dynamic Form</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDynamicForm(DynamicForm object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Advertisment</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Advertisment</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAdvertisment(Advertisment object) {
		return null;
	}
