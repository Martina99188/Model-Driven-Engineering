...
public class ContentConcernAdapterFactory extends AdapterFactoryImpl {
	...
	protected ContentConcernSwitch<Adapter> modelSwitch =
		new ContentConcernSwitch<Adapter>() {
			...
			@Override
			public Adapter caseDynamicForm(DynamicForm object) {
				return createDynamicFormAdapter();
			}
			@Override
			public Adapter caseAdvertisment(Advertisment object) {
				return createAdvertismentAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link NewGlot.ContentConcern.Page <em>Page</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link NewGlot.ContentConcern.DynamicContent <em>Dynamic Content</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link NewGlot.ContentConcern.Index <em>Index</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link NewGlot.ContentConcern.Individual <em>Individual</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link NewGlot.ContentConcern.DynamicForm <em>Dynamic Form</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDynamicFormAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link NewGlot.ContentConcern.Advertisment <em>Advertisment</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createAdvertismentAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link NewGlot.NamedElement <em>Named Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
