/**
 */
package NewGlot.DataConcern.provider;
...
/**
 * This is the item provider adapter for a {@link NewGlot.DataConcern.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DataConcernPackage.Literals.ENTITY__ATTRIBUTES);
			childrenFeatures.add(DataConcernPackage.Literals.ENTITY__REFERENCES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DataConcernPackage.Literals.ENTITY__ATTRIBUTES,
				 DataConcernFactory.eINSTANCE.createAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(DataConcernPackage.Literals.ENTITY__REFERENCES,
