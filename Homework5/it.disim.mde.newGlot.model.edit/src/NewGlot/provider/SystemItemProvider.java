...
/**
 * This is the item provider adapter for a {@link NewGlot.System} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SystemItemProvider extends NamedElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addConcatVersionPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NewGlotPackage.Literals.SYSTEM__VERSION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NewGlotPackage.Literals.SYSTEM__SUBVERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Concat Version feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addConcatVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_System_concatVersion_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_System_concatVersion_feature", "_UI_System_type"),
				 NewGlotPackage.Literals.SYSTEM__CONCAT_VERSION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NewGlotPackage.Literals.SYSTEM__ENTITIES);
			childrenFeatures.add(NewGlotPackage.Literals.SYSTEM__PAGES);
			childrenFeatures.add(NewGlotPackage.Literals.SYSTEM__FORMS);
		}
	...
	public String getText(Object object) {
		String label = ((NewGlot.System)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NewGlot.System.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NewGlotPackage.Literals.SYSTEM__ENTITIES,
				 DataConcernFactory.eINSTANCE.createEntity()));

		newChildDescriptors.add
			(createChildParameter
				(NewGlotPackage.Literals.SYSTEM__PAGES,
				 ContentConcernFactory.eINSTANCE.createPage()));

		newChildDescriptors.add
			(createChildParameter
				(NewGlotPackage.Literals.SYSTEM__FORMS,
