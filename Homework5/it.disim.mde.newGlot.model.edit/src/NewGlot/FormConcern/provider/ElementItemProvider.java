...
/**
 * This is the item provider adapter for a {@link NewGlot.FormConcern.Element} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addHintPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_hint_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_hint_feature", "_UI_Element_type"),
				 FormConcernPackage.Literals.ELEMENT__HINT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
